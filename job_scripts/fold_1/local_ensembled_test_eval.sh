...
export NUM_SEEDS=30
export PREDICTION_PATH=/scratch365/pmoreira/pads_ensembled_test_v3/output_1/predictions
export DATASET_NAME=msh_tanzania_bal-1
export OUTPUT_PATH=/scratch365/pmoreira/pads_ensembled_test_v3/output_1/test_results
